...
class ChatAdapterRecipient : RecyclerView.Adapter<ChatViewHolder>() {

    private var mList: List<MessageModel> = arrayListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatViewHolder {
        val item =
            LayoutInflater.from(parent.context).inflate(R.layout.row_chat_message_recipient, parent, false)
